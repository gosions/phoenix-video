package com.ginkgocap.ywxt.video.utils.agora.tool;


import com.ginkgocap.ywxt.video.utils.agora.media.DynamicKey4;
...
public class DynamicKey4Sample {
    ...
    static int ts = (int)(System.currentTimeMillis()/1000);
